...
install: 
	...
	cd $(SM_STAGING)$(SM_DEST) && rm -f OCFSSR && ln -sf OCFSSR.py OCFSSR
	cd $(SM_STAGING)$(SM_DEST) && rm -f OCFSoISCSISR && ln -sf OCFSoISCSISR.py OCFSoISCSISR
	cd $(SM_STAGING)$(SM_DEST) && rm -f OCFSoHBASR && ln -sf OCFSoHBASR.py OCFSoHBASR
